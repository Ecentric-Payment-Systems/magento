...
class Ece extends \Magento\Framework\View\Element\Template
{
    ...
    public function getParameters()
    {
		...
		if($last_order_id){
			...
			$ecentric_mode = $this->_scopeConfig->getValue('payment/ecepay/ecentric_mode', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
			
			$mode_data = array(
				'sandbox' => 'ecentricjs',
				'production_1' => 'ecentricspro1js',
				'production_2' => 'ecentricspro2js',
			);
			...
			if($ecentric_merchantid && $ecentric_key){
				...
				$MerchantReference = 'order'.$last_order_id;
